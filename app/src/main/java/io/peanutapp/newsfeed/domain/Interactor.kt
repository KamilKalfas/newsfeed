...
interface Interactor<in Params, out Results> {
    ...
    operator fun invoke(params: Params): Results
}
...
fun <Params, Results> CoroutineScope.workAsync(interactor: Interactor<Params, Results>, params: Params): Deferred<Results> {
